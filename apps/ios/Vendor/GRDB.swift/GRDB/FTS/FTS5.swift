  ...
  public struct FTS5 {
    ...
    public static func api(_ db: Database) -> UnsafePointer<fts5_api> {
      ...
      type.utf8Start.withMemoryRebound(to: CChar.self, capacity: type.utf8CodeUnitCount) {
        typePointer in
  ...
  extension FTS5: VirtualTableModule {
    ...
    public func moduleArguments(for definition: FTS5TableDefinition, in db: Database) throws
      -> [String]
    {
    ...
    public func database(
      _ db: Database, didCreate tableName: String, using definition: FTS5TableDefinition
    ) throws {
      switch definition.contentMode {
      case .raw:
        break
      case .synchronized(let contentTable):
        ...
        let ifNotExists =
          definition.configuration.ifNotExists
          ? "IF NOT EXISTS "
          : ""
