...
where Self: RawRepresentable, Self.RawValue: SQLSpecificExpressible {}
...
where Self: RawRepresentable, Self.RawValue: StatementColumnConvertible {
  @inline(__always)
  @inlinable
...
where Self: RawRepresentable, Self.RawValue: DatabaseValueConvertible {
