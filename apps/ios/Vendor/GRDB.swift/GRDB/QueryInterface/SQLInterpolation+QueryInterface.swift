extension SQLInterpolation {
  ...
  public mutating func appendInterpolation(
    columnsOf recordType: (some TableRecord).Type, tableAlias: String? = nil
  ) {
    ...
    elements.append(
      contentsOf: recordType.databaseSelection
  ...
  ///         """
  public mutating func appendInterpolation(
    _ expressible: some SQLExpressible
      & SQLSelectable
      & SQLOrderingTerm
  ) {
  ...
  ///         """
  public mutating func appendInterpolation(
    _ subquery: some SQLSubqueryable
      & SQLExpressible
      & SQLSelectable
      & SQLOrderingTerm
  ) {
  ...
  public mutating func appendInterpolation(
    ...
    if e.isEmpty {
      ...
      appendLiteral("(")
      elements.append(
        contentsOf: e.map(CollectionOfOne.init(_:)).joined(separator: CollectionOfOne(.sql(","))))
      appendLiteral(")")
    }
  }
