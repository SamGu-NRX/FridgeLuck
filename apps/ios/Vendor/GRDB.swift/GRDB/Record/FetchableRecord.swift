...
extension FetchableRecord {
  ...
  public static func databaseDataDecodingStrategy(for column: String)
    -> DatabaseDataDecodingStrategy
  {
    .deferredToData
  }
...
extension FetchableRecord {
  ...
  /// - returns: A ``RecordCursor`` over fetched records.
  /// - throws: A ``DatabaseError`` whenever an SQLite error occurs.
  public static func fetchCursor(_ db: Database, _ request: some FetchRequest) throws
    -> RecordCursor<Self>
  {
...
public enum DatabaseColumnDecodingStrategy: Sendable {
  ...
  static func _convertFromSnakeCase(_ stringKey: String) -> String {
    ...
    if leadingUnderscoreRange.isEmpty && trailingUnderscoreRange.isEmpty {
      ...
      result =
        String(stringKey[leadingUnderscoreRange])
        + joinedString
