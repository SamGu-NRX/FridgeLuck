...
// MARK: - UnsafeSendableMutex

/// `UnsafeSendableMutex` is a Mutex that is always Sendable. It is unsafe,
/// because it does not guarantee that its value won't escape from the
/// critical section.
///
/// We'll replace it with the SE-0433 Mutex when it is available.
/// <https://github.com/apple/swift-evolution/blob/main/proposals/0433-mutex.md>
///
/// For a longer discussion about Sendable and mutexes, see
/// <https://github.com/apple/swift-evolution/blob/main/proposals/0433-mutex.md#interactions-with-swift-concurrency>
final class UnsafeSendableMutex<T>: @unchecked Sendable {
  private var _value: T
  private var lock = NSLock()
