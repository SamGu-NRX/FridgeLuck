...
extension AssociationToMany {
  ...
  /// }
  /// ```
  public func average(_ expression: some SQLSpecificExpressible) -> AssociationAggregate<
    OriginRowDecoder
  > {
    ...
    if let column = expression as? any ColumnExpression {
      ...
      return aggregate.forKey(
        "average\(name.uppercasingFirstCharacter)\(column.name.uppercasingFirstCharacter)")
    } else {
      return aggregate
    }
  }
  ...
  /// }
  /// ```
  public func max(_ expression: some SQLSpecificExpressible) -> AssociationAggregate<
    OriginRowDecoder
  > {
    ...
    if let column = expression as? any ColumnExpression {
      let name = key.singularizedName
      return aggregate.forKey(
        "max\(name.uppercasingFirstCharacter)\(column.name.uppercasingFirstCharacter)")
    } else {
      return aggregate
    }
  }
  ...
  /// }
  /// ```
  public func min(_ expression: some SQLSpecificExpressible) -> AssociationAggregate<
    OriginRowDecoder
  > {
    ...
    if let column = expression as? any ColumnExpression {
      let name = key.singularizedName
      return aggregate.forKey(
        "min\(name.uppercasingFirstCharacter)\(column.name.uppercasingFirstCharacter)")
    } else {
      return aggregate
    }
  }
  ...
  /// }
  /// ```
  public func sum(_ expression: some SQLSpecificExpressible) -> AssociationAggregate<
    OriginRowDecoder
  > {
  ...
  /// }
  /// ```
  public func total(_ expression: some SQLSpecificExpressible) -> AssociationAggregate<
    OriginRowDecoder
  > {
  ...
  AssociationAggregatePreparation<Association.OriginRowDecoder>
{
  ...
  override func prepare(_ request: inout some DerivableRequest<Association.OriginRowDecoder>)
    -> SQLExpression
  {
  ...
  -> AssociationAggregate<RowDecoder>
{
  AssociationAggregate(
    preparation: CombinePreparation(lhs.preparation, rhs.preparation, combine: combine))
}
