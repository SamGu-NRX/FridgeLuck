...
public func cast(_ expression: some SQLSpecificExpressible, as storageClass: Database.StorageClass)
  -> SQLExpression
{
...
public func max(
  ...
  .simpleFunction(
    "MAX", [value1.sqlExpression, value2.sqlExpression] + values.map(\.sqlExpression))
}
...
public func min(
  ...
  .simpleFunction(
    "MIN", [value1.sqlExpression, value2.sqlExpression] + values.map(\.sqlExpression))
}
...
///
/// Related SQLite documentation: <https://www.sqlite.org/lang_datefunc.html>
public func julianDay(_ value: some SQLSpecificExpressible, _ modifiers: SQLDateModifier...)
  -> SQLExpression
{
...
///
/// Related SQLite documentation:<https://www.sqlite.org/lang_datefunc.html>
public func dateTime(_ value: some SQLSpecificExpressible, _ modifiers: SQLDateModifier...)
  -> SQLExpression
{
