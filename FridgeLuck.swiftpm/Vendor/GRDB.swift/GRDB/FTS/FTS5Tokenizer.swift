  ...
  public typealias FTS5TokenCallback =
    @convention(c) (
  ...
  extension FTS5Tokenizer {
    ...
    {
      try ContiguousArray(string.utf8).withUnsafeBufferPointer {
        buffer -> [(String, FTS5TokenFlags)] in
        ...
        try withUnsafeMutablePointer(to: &context) { contextPointer in
          let code = tokenize(
            ...
            nText: nText,
            tokenCallback: {
              (contextPointer, flags, pToken, nToken, _ /* iStart */, _ /* iEnd */) in
  ...
  extension Database {
    ...
    private final class FTS5RegisteredTokenizer: FTS5Tokenizer {
      ...
      init(
        xTokenizer: fts5_tokenizer, contextPointer: UnsafeMutableRawPointer?, arguments: [String]
      ) throws {
        ...
        -> CInt
      {
        ...
        return xTokenize(
          tokenizerPointer, context, tokenization.rawValue, pText, nText, tokenCallback)
      }
    }
