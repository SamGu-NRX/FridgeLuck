...
extension StatementColumnConvertible {
  ...
  @inline(__always)
  @inlinable
  public static func fromStatement(_ sqliteStatement: SQLiteStatement, atUncheckedIndex index: CInt)
    -> Self?
  {
...
extension DatabaseValueConvertible where Self: StatementColumnConvertible {
    ...
    throws -> Self
  {
    if let value = fromStatement(sqliteStatement, atUncheckedIndex: index) {
      ...
      try _valueMismatch(
        fromStatement: sqliteStatement, atUncheckedIndex: index, context: context())
    }
  }
...
where RowDecoder: DatabaseValueConvertible & StatementColumnConvertible & Hashable {
