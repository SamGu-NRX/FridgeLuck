...
extension String {
  ...
  private static let sqlStatementSeparators = CharacterSet(charactersIn: ";").union(
...
public final class Statement {
  ...
  public func setArguments(_ arguments: StatementArguments) throws {
    ...
    let bindings = try consumedArguments.extractBindings(
      forStatement: self, allowingRemainingValues: false)
